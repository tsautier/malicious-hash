Update of the following table: 2026-09-06 18:17 CEST

| File | Number of hashes |
| ---- | ---------------- |
| full-hash-md5 | 4 090 |
| full-hash-sha1 | 605 |
| full-hash-sha256 | 23 656 |
...
| Source | Link | History | Description |
| ------------------------- | ------ | ------- | ----------- |
| abuse.ch Malware Bazaar | [link](https://bazaar.abuse.ch/) | 120d | Sharing malware samples |
